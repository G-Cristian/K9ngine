...
namespace K9 {
	namespace Graphics {
		void BumpMappingRenderer::draw(const World& world, const std::set<std::shared_ptr<const K9::Components::RenderingComponent>>& renderingComponents) const {
		...
		glm::mat4 BumpMappingRenderer::initModelMatrix(const K9::Components::RenderingComponent& renderingComponent) const {
		...
		glm::mat4 BumpMappingRenderer::initViewMatrix(const World& world) const {
		...
		glm::mat4 BumpMappingRenderer::initProjMatrix(const World& world) const {
		...
		void BumpMappingRenderer::initLights(const World& world, const glm::mat4& viewMatrix) const {
		...
		void BumpMappingRenderer::initVectorColorMaterial(GLint loc, std::shared_ptr<const MaterialComponent> materialComponent)const {
		...
		void BumpMappingRenderer::initFloatColorMaterial(GLint loc, std::shared_ptr<const MaterialComponent> materialComponent)const {
			K9_ASSERT(materialComponent != nullptr);
			if (materialComponent != nullptr) {
